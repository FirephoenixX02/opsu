...
public class OpsuConstants {
	...
	/** Project author. */
	public static final String PROJECT_AUTHOR = "@itdelatrisu and modified by @FirephoenixX02";

	/** Website address. */
	public static final URI WEBSITE_URI = URI.create("https://itdelatrisu.github.io/opsu/");

	/** Repository address. */
	public static final URI REPOSITORY_URI = URI.create("https://github.com/FirephoenixX02/opsu");

	/** Credits address. */
	public static final URI CREDITS_URI = URI.create("https://github.com/FirephoenixX02/opsu/blob/master/CREDITS.md");
